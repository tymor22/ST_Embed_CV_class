...
class CountVAE(nn.Module):
    ...
    def inference(
        self, x, library, batch_index=None, y=None, n_samples=1, transform_batch=None
    ...
    def forward(
        self, x, library, batch_index=None, y=None
        ...
        outputs = self.inference(x, library, batch_index, y)
        qz_m = outputs["qz_m"]
        qz_v = outputs["qz_v"]
