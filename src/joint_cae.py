...
def train_joint_vae(nnet, model, train_loader, optimiser, epoch, num_epoch, learning_rate, log_interval):
    ...
    for i, sample_batched in enumerate(train_loader):
        ...
        combined_loss = train_loss + img_loss + trip_loss
    ...
    save_path_nnet = "/mnt/home/thamamsy/projects/ST_Embed/models/joint_cae/jcae_triplet_nnet_" + str(epoch) + '.pth' 
    save_path_model = "/mnt/home/thamamsy/projects/ST_Embed/models/joint_cae/jcae_triplet_model_" + str(epoch) + '.pth'
